...
export const strings = {
  common: {
    ...
    panels: {
      ...
      /**
       * Sol global panel header'ındaki X butonu için hover tooltip metni —
       * Esc kısayolunu da gösterir. Aria-label sade "Kapat" kalır
       * (`board.<panel>.close`); tooltip kullanıcıya kısayolu hatırlatır.
       */
  ...
  board: {
    ...
    // Görevlerim paneli (Faz 17) — sol kenarda 4. global panel. Kullanıcının
    // `assignee` olarak atandığı, açık (completed=false) ve arşivsiz tüm
    // kartları gösterir. Frontend tarih gruplarına ayırır.
    myTasks: {
      panelTitle: 'Görevlerim',
      toggle: 'Görevlerim',
      open: 'Görevlerim panelini aç',
      close: 'Görevlerim panelini kapat',
      refresh: 'Yenile',
      groupOverdue: 'Vadesi geçti',
      groupToday: 'Bugün',
      groupThisWeek: 'Bu hafta',
      groupLater: 'Sonra',
      groupNoDueDate: 'Vadesi yok',
      emptyTitle: 'Atanan görev yok',
      emptyDescription:
    ...
    // Aktivite Akışı paneli (Faz 17) — sol kenarda 5. global panel.
    // Kullanıcının erişebildiği tüm board'lardan global aktivite feed'i,
    // cursor-paginated, tip filtresi chip'leriyle.
    activityFeed: {
      panelTitle: 'Aktivite Akışı',
      toggle: 'Aktivite Akışı',
      open: 'Aktivite Akışı panelini aç',
      close: 'Aktivite Akışı panelini kapat',
      refresh: 'Yenile',
      ...
      // Chip filtreleri — `ACTIVITY_FEED_GROUPS` ile birebir eşleşmeli.
      filterAll: 'Tümü',
      filterCardChanges: 'Kart hareketleri',
      filterComments: 'Yorumlar',
      filterChecklists: 'Checklist',
      filterMembers: 'Üyeler',
      filterOther: 'Diğer',
      anonymousActor: 'Bilinmeyen',
      // Tipler için kısa Türkçe özet. Bilinmeyen tip için fallback.
      typeLabels: {
        'card.created': 'kart oluşturdu',
        'card.updated': 'kartı güncelledi',
        'card.moved': 'kartı taşıdı',
        'card.renamed': 'kartı yeniden adlandırdı',
        'card.description_changed': 'kart açıklamasını değiştirdi',
        'card.archived': 'kartı arşivledi',
        'card.deleted': 'kartı kalıcı sildi',
        'card.completed': 'kartı tamamladı',
        'card.uncompleted': 'kart tamamlama işaretini kaldırdı',
        'card.due_set': 'karta vade ekledi',
        'card.due_cleared': 'kart vadesini kaldırdı',
        'card.label_added': 'karta etiket ekledi',
        'card.label_removed': 'karttan etiket kaldırdı',
        'card.cover_changed': 'kart kapak rengini değiştirdi',
        'card.cover_cleared': 'kart kapak rengini kaldırdı',
        'card.cover_image_changed': 'kart kapak görselini değiştirdi',
        'card.cover_image_cleared': 'kart kapak görselini kaldırdı',
        'card.member_added': 'karta üye ekledi',
        'card.member_removed': 'karttan üye kaldırdı',
        'comment.created': 'yorum yazdı',
        'comment.updated': 'yorumu düzenledi',
        'comment.deleted': 'yorumu sildi',
        'comment.mentioned': 'birini bahsetti',
        'checklist.created': 'checklist oluşturdu',
        'checklist.item_added': 'checklist maddesi ekledi',
        'checklist.item_checked': 'checklist maddesini işaretledi',
        'checklist.item_unchecked': 'checklist madde işaretini kaldırdı',
        'checklist.item_removed': 'checklist maddesini sildi',
        'checklist.item_completed': 'checklist maddesini tamamladı',
        'attachment.added': 'dosya ekledi',
        'attachment.removed': 'dosyayı kaldırdı',
        'list.created': 'liste oluşturdu',
        'list.updated': 'listeyi güncelledi',
        'list.moved': 'listeyi taşıdı',
        'list.renamed': 'listeyi yeniden adlandırdı',
        'list.archived': 'listeyi arşivledi',
        'list.deleted': 'listeyi kalıcı sildi',
        'list.color_changed': 'liste rengini değiştirdi',
        'list.color_cleared': 'liste rengini kaldırdı',
        'list.icon_changed': 'liste ikonunu değiştirdi',
        'list.icon_cleared': 'liste ikonunu kaldırdı',
        'board.created': 'pano oluşturdu',
        ...
        'board.member_added': 'panoya üye ekledi',
        'board.member_removed': 'panodan üye kaldırdı',
        'board.member_role_changed': 'pano üye rolünü değiştirdi',
        'board.member_invited': 'panoya davet gönderdi',
        'board.invitation_revoked': 'pano davetini iptal etti',
        'workspace.created': 'çalışma alanı oluşturdu',
        'workspace.updated': 'çalışma alanını güncelledi',
        'workspace.archived': 'çalışma alanını arşivledi',
        'workspace.member_added': 'çalışma alanına üye ekledi',
        'workspace.member_removed': 'çalışma alanından üye kaldırdı',
        'workspace.member_role_changed': 'çalışma alanı üye rolünü değiştirdi',
        'workspace.member_invited': 'çalışma alanına davet gönderdi',
    ...
    navigator: {
      ...
      emptyTitle: 'Hiç kart yok',
      emptyDescription: 'Erişebildiğiniz bir kart henüz yok.',
      emptySearchDescription: 'Aramana uyan kart yok.',
