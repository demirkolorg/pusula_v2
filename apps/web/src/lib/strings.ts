...
export const strings = {
  ...
  auth: {
    ...
    verifyEmail: {
      ...
      cooldownLabel: (seconds: number) => `Tekrar gonder (${seconds}sn)`,
  ...
  board: {
    ...
    background: {
      ...
      colorNames: {
        ...
        siyah: 'Siyah',
        beyaz: 'Beyaz',
        'kirik-beyaz': 'Kirik beyaz',
        fildisi: 'Fildisi',
        'buz-beyazi': 'Buz beyazi',
        gumus: 'Gumus',
      },
    },
    filter: {
  ...
  share: {
    ...
    dialog: {
      ...
      createdHint: 'Bu bağlantıyı şimdi kopyala. Token bir daha görüntülenmez.',
    ...
    list: {
      ...
      openLink: 'Linke git',
      openLinkUnavailable: 'Token güvenlik gereği yeniden gösterilemez',
    },
    guest: {
