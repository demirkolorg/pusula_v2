...
export interface DeleteAccountViewProps {
   ...
   * `(auth)/sign-in`'e yönlendirir; bu yüzden başarı yolunda `onDone`
...
/**
 * Hesap silme görünümü (DEM-212) — yeni tRPC yok: doğrudan Better Auth
 ...
 *
 * Başarılı silmede oturum boşalır → `(app)/_layout` otomatik olarak
 * `(auth)/sign-in`'e yönlendirir (mevcut signOut deseni). Faz 15C tablet
