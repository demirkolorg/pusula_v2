...
/**
 * Bildirim ayarları görünümü (Faz 7K) — içerik. Native header (`Stack.Screen`)
 * route sarmalayıcısında verilir; bu görünüm yalnız gövdeyi çizer.
 *
 ...
 * (`useNotificationPreferences`).
 *
 * Faz 15C tablet master-detail (DEM-303): tablet'te kendi içinde master-detail
 * (sol 5 kategori + sağ seçili kategori). Hem `(notifications)/notification-settings`
 * route'unda hem tablet hesap detail pane'inde **gömülü** kullanılır (kullanıcı
 * kararı — detail pane içinde iç içe master-detail).
 */
