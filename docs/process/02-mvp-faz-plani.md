...
| **1 — Auth & Workspace** | Better Auth sign-in/up/out akışları, session yönetimi, Workspace CRUD, workspace member modeli, permission helper'ları procedure'lere bağlı | Kullanıcı login olup workspace görebilir | ✅ Tamam (tüm alt + ek işler `Done`) | _Faz 1_ milestone · [DEM-20](https://linear.app/demirkol/issue/DEM-20) (Done), [DEM-22](https://linear.app/demirkol/issue/DEM-22) (Done), [DEM-23](https://linear.app/demirkol/issue/DEM-23) (Done), [DEM-24](https://linear.app/demirkol/issue/DEM-24) (Done), [DEM-39](https://linear.app/demirkol/issue/DEM-39) (Done), [DEM-40](https://linear.app/demirkol/issue/DEM-40) (Done) |
| **2 — Board/List/Card CRUD** | Board/List/Card CRUD (tRPC + Drizzle), temel board ekranı, transaction yapısı | Kullanıcı pano/liste/kart oluşturabilir | 🔄 Aktif (Faz 2.0 `Done`; Faz 2A `In Progress`; 2B/2C/2D `Sonraki Faz`) | _Faz 2_ milestone · [DEM-25](https://linear.app/demirkol/issue/DEM-25) (epic) → [DEM-33](https://linear.app/demirkol/issue/DEM-33) (Done) · [DEM-34](https://linear.app/demirkol/issue/DEM-34) (In Progress) · [DEM-35](https://linear.app/demirkol/issue/DEM-35) · [DEM-36](https://linear.app/demirkol/issue/DEM-36) · [DEM-37](https://linear.app/demirkol/issue/DEM-37) |
...
Linear'da hepsi DEM-25 altında, `Faz 2 — Board/List/Card CRUD` milestone'unda; **DEM-33 (önce belge) `Done`**, **DEM-34 (Faz 2A) `In Progress`**, DEM-35–37 `Sonraki Faz` —
`Sonraki Faz` = `Backlog` ile `Todo` arasında ara katman ("bir sonraki faz, planlı"); faz geliştirmesi başlayınca o iş `Todo`'ya
