...
| --- | --- | --- |
| Board | `board.created`, `board.renamed`, `board.archived`, `board.member_added`, `board.member_removed`, `board.member_role_changed` | eski/yeni başlık, üye id, rol |
...
| Card members/labels | `card.member_added`, `card.member_removed`, `card.label_added`, `card.label_removed` | üye id / label id |
