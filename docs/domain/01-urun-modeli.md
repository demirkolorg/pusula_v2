...
| **List** | Board içindeki kolon. Bir board'a aittir. Arşivlenebilir; renkli olabilir (`color` — `@pusula/domain` `LIST_COLORS` paletinden 10 ad veya `null`). |
