...
| **Süreç**            | _Nasıl çalışıyoruz?_                 | [`process/`](process/)           | Çalışma başlangıç rehberi ve dokümantasyon yazım kuralları                                                                    |
...
- "Yeni işe nereden başlanır / yeni Markdown dosyası nasıl yazılır?" → `process/`
